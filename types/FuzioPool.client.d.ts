...
import { Uint128, WalletInfo, Expiration, TokenSelect, BalanceResponse, FeeResponse, InfoResponse, Token1ForToken2PriceResponse, Token2ForToken1PriceResponse } from "./FuzioPool.types";
...
export interface FuzioPoolInterface extends FuzioPoolReadOnlyInterface {
    contractAddress: string;
    sender: string;
...
export declare class FuzioPoolClient extends FuzioPoolQueryClient implements FuzioPoolInterface {
