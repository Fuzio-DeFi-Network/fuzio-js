...
export interface FuzioPoolListInterface extends FuzioPoolListReadOnlyInterface {
    contractAddress: string;
    sender: string;
...
export declare class FuzioPoolListClient extends FuzioPoolListQueryClient implements FuzioPoolListInterface {
