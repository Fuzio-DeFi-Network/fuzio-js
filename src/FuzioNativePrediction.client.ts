...
export class FuzioNativePredictionClient extends FuzioNativePredictionQueryClient implements FuzioNativePredictionInterface {
  ...
  collectWinnings = async (fee: number | StdFee | "auto" = "auto", memo?: string, funds?: Coin[]): Promise<ExecuteResult> => {
    return await this.client.execute(this.sender, this.contractAddress, {
      collect_winnings: {}
    }, fee, memo, funds);
  };
  ...
  halt = async (fee: number | StdFee | "auto" = "auto", memo?: string, funds?: Coin[]): Promise<ExecuteResult> => {
    return await this.client.execute(this.sender, this.contractAddress, {
      halt: {}
    }, fee, memo, funds);
  };
