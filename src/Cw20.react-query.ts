...
export const cw20QueryKeys = {
  ...
  address: (contractAddress: string) => ([{ ...cw20QueryKeys.contract[0],
    address: contractAddress
  }] as const),
  balance: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20QueryKeys.address(contractAddress)[0],
    method: "balance",
    args
  }] as const),
  tokenInfo: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20QueryKeys.address(contractAddress)[0],
    method: "token_info",
    args
  }] as const),
  minter: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20QueryKeys.address(contractAddress)[0],
    method: "minter",
    args
  }] as const),
  allowance: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20QueryKeys.address(contractAddress)[0],
    method: "allowance",
    args
  }] as const),
  allAllowances: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20QueryKeys.address(contractAddress)[0],
    method: "all_allowances",
    args
  }] as const),
  allSpenderAllowances: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20QueryKeys.address(contractAddress)[0],
    method: "all_spender_allowances",
    args
  }] as const),
  allAccounts: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20QueryKeys.address(contractAddress)[0],
    method: "all_accounts",
    args
  }] as const),
  marketingInfo: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20QueryKeys.address(contractAddress)[0],
    method: "marketing_info",
    args
  }] as const),
  downloadLogo: (contractAddress: string, args?: Record<string, unknown>) => ([{ ...cw20QueryKeys.address(contractAddress)[0],
...
export const cw20Queries = {
  ...
  allSpenderAllowances: <TData = AllSpenderAllowancesResponse,>({
    ...
    args,
    options
  }: Cw20AllSpenderAllowancesQuery<TData>): UseQueryOptions<AllSpenderAllowancesResponse, Error, TData> => ({
    queryKey: cw20QueryKeys.allSpenderAllowances(client?.contractAddress, args),
...
export function useCw20DownloadLogoQuery<TData = DownloadLogoResponse>({
  ...
  return useQuery<DownloadLogoResponse, Error, TData>(cw20QueryKeys.downloadLogo(client.contractAddress), () => client.downloadLogo(), options);
}
...
export function useCw20MarketingInfoQuery<TData = MarketingInfoResponse>({
  ...
  return useQuery<MarketingInfoResponse, Error, TData>(cw20QueryKeys.marketingInfo(client.contractAddress), () => client.marketingInfo(), options);
}
...
export function useCw20AllAccountsQuery<TData = AllAccountsResponse>({
  ...
  return useQuery<AllAccountsResponse, Error, TData>(cw20QueryKeys.allAccounts(client.contractAddress, args), () => client.allAccounts({
    limit: args.limit,
    startAfter: args.startAfter
  }), options);
}
...
export function useCw20AllSpenderAllowancesQuery<TData = AllSpenderAllowancesResponse>({
  client,
  args,
  options
}: Cw20AllSpenderAllowancesQuery<TData>) {
  return useQuery<AllSpenderAllowancesResponse, Error, TData>(cw20QueryKeys.allSpenderAllowances(client.contractAddress, args), () => client.allSpenderAllowances({
    limit: args.limit,
    spender: args.spender,
    startAfter: args.startAfter
  }), options);
...
export function useCw20AllAllowancesQuery<TData = AllAllowancesResponse>({
  ...
  return useQuery<AllAllowancesResponse, Error, TData>(cw20QueryKeys.allAllowances(client.contractAddress, args), () => client.allAllowances({
    limit: args.limit,
    owner: args.owner,
    startAfter: args.startAfter
  }), options);
...
export function useCw20AllowanceQuery<TData = AllowanceResponse>({
  ...
  return useQuery<AllowanceResponse, Error, TData>(cw20QueryKeys.allowance(client.contractAddress, args), () => client.allowance({
    owner: args.owner,
    spender: args.spender
  }), options);
}
...
export function useCw20MinterQuery<TData = MinterResponse>({
  ...
  return useQuery<MinterResponse, Error, TData>(cw20QueryKeys.minter(client.contractAddress), () => client.minter(), options);
}
...
export function useCw20TokenInfoQuery<TData = TokenInfoResponse>({
  ...
  return useQuery<TokenInfoResponse, Error, TData>(cw20QueryKeys.tokenInfo(client.contractAddress), () => client.tokenInfo(), options);
}
...
export function useCw20BalanceQuery<TData = BalanceResponse>({
  ...
  return useQuery<BalanceResponse, Error, TData>(cw20QueryKeys.balance(client.contractAddress, args), () => client.balance({
    address: args.address
  }), options);
}
